...
namespace UnityEngine.Rendering.Universal
{
    ...
    internal static class ShaderPropertyId
    {
        ...
        public static readonly int isInUICamera = Shader.PropertyToID("_IsInUICamera"); // Add by: wuyanlong
    }
    ...
    public static class ShaderKeywordStrings
    {
        ...
        public static readonly string SRGBToLinearConversion = "_SRGB_TO_LINEAR_CONVERSION"; // Add by: wuyanlong
