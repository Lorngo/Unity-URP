...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class PostProcessPass : ScriptableRenderPass
    {
        ...
        private int m_ChangeUIGraphic = 0;
        ...
        public void Setup(in RenderTextureDescriptor baseDescriptor, in RenderTargetHandle source, bool resolveToScreen, in RenderTargetHandle depth, in RenderTargetHandle internalLut, in RenderTargetHandle uiTarget, bool hasFinalPass, bool enableSRGBConversion)
        {
        ...
        public void SetupFinalPass(in RenderTargetHandle source, in RenderTargetHandle uguiTarget, bool useSwapBuffer = false)
        {
            m_Source = source.id;
            m_Destination = RenderTargetHandle.CameraTarget;
            m_IsFinalPass = true;
        ...
        void Render(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            if (m_isUICamera)
            {
                source = m_UguiTarget.Identifier();
            }
            ...
            using (new ProfilingScope(cmd, ProfilingSampler.Get(URPProfileId.UberPostProcess)))
            {
                ...
                if (m_UseSwapBuffer)
                {
                    ...
                    if (m_ChangeUIGraphic == 1)
                    {
                        m_ResolveToScreen = cameraData.resolveFinalTarget || (m_HasFinalPass == true);
                        m_UseSwapBuffer = !m_UseSwapBuffer;
                    }
                }
                else
                {
