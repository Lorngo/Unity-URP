...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed class UniversalRenderer : ScriptableRenderer
    {
        ...
        public UniversalRenderer(UniversalRendererData data) : base(data)
        {
            ...
            //Add By:Wuyanlong
            m_UguiPass = new DrawObjectsPass("UGUIRenderPass", false, RenderPassEvent.BeforeRenderingTransparents + 1,
                RenderQueueRange.transparent, LayerMask.GetMask("UI"), m_DefaultStencilState,
                stencilData.stencilReference);

            //如果没有后处理阶段的时候需要添加一个阶段作为两个RT之间交换
        ...
        public override void Setup(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            if (isOffscreenDepthTexture)
            {
                ...
                EnqueuePass(m_UguiPass); // Add By: Wuyanlong
                return;
            }
            ...
            if (lastCameraInTheStack)
            {
                ...
                if (applyPostProcessing)
                {
                    ...
                    postProcessPass.Setup(cameraTargetDescriptor, m_ActiveCameraColorAttachment, resolvePostProcessingToCameraTarget, m_ActiveCameraDepthAttachment, colorGradingLut, m_UguiTaget, applyFinalPostProcessing, doSRGBConversion);
                ...
                {
                    finalPostProcessPass.SetupFinalPass(sourceForFinalPass, m_UguiTaget, true);
                ...
                {
                    sourceForFinalPass = isUICamera ? m_UguiTaget : sourceForFinalPass;
            ...
            {
                postProcessPass.Setup(cameraTargetDescriptor, m_ActiveCameraColorAttachment, false, m_ActiveCameraDepthAttachment, colorGradingLut, m_UguiTaget, false, false);
                EnqueuePass(postProcessPass);
            }
